    ...
    constructor(){
        ...
        render(){
            return(
                ...
                <h4>Selamat Datang Neilsya Amstrani !</h4>
                <br></br>
                    ...
                    <div className="modal" id="modal_buku" >
                        <div className="modal-dialog">
                            ...
                            {/* modal header */}
                                ...
                                Form Buku
                                <button type="button" class="btn-close" aria-label="Close" onClick={()=>this.close()}></button>
                                </div>
                                {/* modal body */}
                                <div className="modal-body">
                                    <form onSubmit={ev => this.Save(ev)}>
                                    ISBN Buku
                                    <input type="text" className="form-control mb-2" value={this.state.isbn} onChange={ ev => this.setState({isbn:ev.target.value}) } required />
                                    Judul Buku
